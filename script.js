const LEVELS = [
  {
    ...
    name: "新手关",
    shortHint: "大小写字母基础配对",
    description: "把同一个字母的大小写连起来，先用最基础的字母配对热身。",
    completeMessage: "新手关完成了，下一关是长元音。",
    groups: [
      { key: "A", label: "A", tokens: ["A", "a"] },
      { key: "B", label: "B", tokens: ["B", "b"] },
      { key: "C", label: "C", tokens: ["C", "c"] },
      { key: "D", label: "D", tokens: ["D", "d"] },
      { key: "E", label: "E", tokens: ["E", "e"] },
      { key: "F", label: "F", tokens: ["F", "f"] },
      { key: "G", label: "G", tokens: ["G", "g"] },
      { key: "H", label: "H", tokens: ["H", "h"] },
      { key: "I", label: "I", tokens: ["I", "i"] },
      { key: "J", label: "J", tokens: ["J", "j"] },
      { key: "K", label: "K", tokens: ["K", "k"] },
      { key: "L", label: "L", tokens: ["L", "l"] },
      { key: "M", label: "M", tokens: ["M", "m"] },
      { key: "N", label: "N", tokens: ["N", "n"] },
      { key: "O", label: "O", tokens: ["O", "o"] },
      { key: "P", label: "P", tokens: ["P", "p"] },
      { key: "Q", label: "Q", tokens: ["Q", "q"] },
      { key: "R", label: "R", tokens: ["R", "r"] },
      { key: "S", label: "S", tokens: ["S", "s"] },
      { key: "T", label: "T", tokens: ["T", "t"] },
      { key: "U", label: "U", tokens: ["U", "u"] },
      { key: "V", label: "V", tokens: ["V", "v"] },
      { key: "W", label: "W", tokens: ["W", "w"] },
      { key: "Y", label: "Y", tokens: ["Y", "y"] },
    ],
  },
  {
    id: "long-vowels",
